...
public class OBHead extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_obhead);
        ...
        custdd = findViewById(R.id.custdd);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        ObhlistItem = new ArrayList<>();
        vcodelist = new ArrayList<>();
        loadcustomerlist(customerurl);
        custdd.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                customer = custdd.getItemAtPosition(custdd.getSelectedItemPosition()).toString();
...
//                        }
                    ...
                    custdd.setAdapter(new ArrayAdapter<String>(OBHead.this, android.R.layout.simple_spinner_dropdown_item, vcodelist));
...
//                            Toast.makeText(getApplicationContext(), "Material Added!", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(OBHead.this, Dashboard.class);
